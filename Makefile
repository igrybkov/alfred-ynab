...
.PHONY: workflow
workflow: alfred-version alfred-readme build
...
.PHONY: release
release: .check-dependencies .check-git-status alfred-version .refresh-version .check-version workflow tag-release tag-push
